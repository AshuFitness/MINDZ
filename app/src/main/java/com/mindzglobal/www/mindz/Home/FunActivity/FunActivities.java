package com.mindzglobal.www.mindz.Home.FunActivity;
...
public class FunActivities extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fun_activity_layout);

        retrofitClient = new RetrofitClient(token);
        manager = new SessionManager();
        token = manager.getPreferences(FunActivities.this, Constants.USER_TOKEN);

        recyclerView = findViewById(R.id.recycler_crime);
        recyclerView.setHasFixedSize(true);
        myOnClickListener = new FunActivities.MyOnClickListener(FunActivities.this);
        layoutManager = new LinearLayoutManager(FunActivities.this);
    ...
    public void CrimeFeeds() {
        ...
        String url = "https://www.homiezin.com/api/feed/FunActivity/";
...
//					emptyElement.setVisibility(View.VISIBLE);
                            ...
                            adapter = new CrimeCustomAdpater((ArrayList<GetFeedx>) FeedCrimeList,FunActivities.this);
                            recyclerView.setAdapter(adapter);
                        }
                    }
                });
