...
import com.mindzglobal.www.mindz.Feeds.adapters.holders.LoadViewHolder;
import com.mindzglobal.www.mindz.Feeds.adapters.holders.PostViewHolder;
...
public class PostsAdapter extends BasePostsAdapter {
    ...
    public PostsAdapter(HomeFragment fragment, SwipeRefreshLayout mSwipeRefreshLayout) {
        super(fragment, mSwipeRefreshLayout);
    }
