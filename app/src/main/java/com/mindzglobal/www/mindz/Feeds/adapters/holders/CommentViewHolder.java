...
import com.mindzglobal.www.mindz.Feeds.adapters.CommentsAdapter;
...
import com.mindzglobal.www.mindz.view.ExpandableTextView;
    ...
    public void bindData(Comment comment) {
        ...
        if (authorId != null)
            profileManager.getProfileSingleValue(authorId,
                    createOnProfileChangeListener(commentTextView, avatarImageView, comment.getText()));
