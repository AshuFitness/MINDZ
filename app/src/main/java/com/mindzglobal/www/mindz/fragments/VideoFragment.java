...
public class VideoFragment extends Fragment implements View.OnClickListener {
    ...
    private AdapterView.OnItemClickListener _itemClickLis = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView parent, View v, int position,
            ...
            /*} else {
                errorDialog.ErrorDialog("Please Upload Video less than 200 mb!!");
                //Log.d("more than 200",""+fileSizeInMB);
            }*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        _gallery =  rootView.findViewById(R.id.gridVideoGallery);
        imageback =  rootView.findViewById(R.id.imageback);
        imageRecordVideo = rootView. findViewById(R.id.imagerecordVideo);
