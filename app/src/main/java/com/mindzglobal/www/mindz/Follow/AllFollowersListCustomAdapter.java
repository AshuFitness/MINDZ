...
public class AllFollowersListCustomAdapter extends RecyclerView.Adapter<FollowCustomAdpater.MyViewHolder> {
...
//        CardView card_view;
    ...
    public AllFollowersListCustomAdapter(ArrayList<FollowList> data, Activity mContext) {
        this.dataSet = data;
...
//        Log.e("followstatusid",followstatus);
        ...
        holder.follow_recru.setTextColor(Color.parseColor("#006400"));
