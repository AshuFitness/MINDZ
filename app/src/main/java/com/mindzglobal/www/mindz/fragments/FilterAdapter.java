...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            this.mTextView =  view.findViewById(R.id.filter_name);
            this.filterImages =  view.findViewById(R.id.list_item_gpuimage);
            this.mViewFrame =  view.findViewById(R.id.cont_filter);
