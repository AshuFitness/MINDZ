...
public class AndroidPermissionMarshMallo {
    ...
    public void requestPermissionForRecord() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.RECORD_AUDIO)) {
            ...
            //Toast.makeText(activity, "Microphone permission needed for recording. Please allow in App AppSettings for additional functionality.", Toast.LENGTH_LONG).show();
        } else {
    ...
    public void requestPermissionForExternalStorage() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE) || ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            // Toast.makeText(activity, "External Storage permission needed. Please allow in App AppSettings for additional functionality.", Toast.LENGTH_LONG).show();
        } else {
    ...
    public void requestPermissionForCamera() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.CAMERA)) {
            ...
            // Logger.d("NEEDED");
            // Toast.makeText(activity, "Camera permission needed. Please allow in App AppSettings for additional functionality.", Toast.LENGTH_LONG).show();
        } else {
    ...
    public void requestPermissionForWriteSetting() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.WRITE_SETTINGS)) {
            ...
            // Toast.makeText(activity, "WRITE_SETTINGS permission needed. Please allow in App AppSettings for additional functionality.", Toast.LENGTH_LONG).show();
        } else {
