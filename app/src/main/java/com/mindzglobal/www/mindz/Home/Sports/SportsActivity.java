package com.mindzglobal.www.mindz.Home.Sports;
...
public class SportsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        token = manager.getPreferences(SportsActivity.this, Constants.USER_TOKEN);

        recyclerView = findViewById(R.id.recycler_crime);
        recyclerView.setHasFixedSize(true);
        myOnClickListener = new SportsActivity.MyOnClickListener(SportsActivity.this);
    ...
    public void CrimeFeeds() {
        ...
        String url = "https://www.homiezin.com/api/feed/Sports/";
...
//					emptyElement.setVisibility(View.VISIBLE);
                            ...
                            adapter = new CrimeCustomAdpater((ArrayList<GetFeedx>) FeedCrimeList,SportsActivity.this);
                            recyclerView.setAdapter(adapter);
                        }
                    }
                });
