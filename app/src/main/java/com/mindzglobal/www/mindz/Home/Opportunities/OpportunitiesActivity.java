package com.mindzglobal.www.mindz.Home.Opportunities;
...
public class OpportunitiesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.opportunity_layout);

        retrofitClient = new RetrofitClient(token);
        manager = new SessionManager();
        token = manager.getPreferences(OpportunitiesActivity.this, Constants.USER_TOKEN);

        recyclerView = findViewById(R.id.recycler_crime);
        recyclerView.setHasFixedSize(true);
        myOnClickListener = new OpportunitiesActivity.MyOnClickListener(OpportunitiesActivity.this);
        layoutManager = new LinearLayoutManager(OpportunitiesActivity.this);
    ...
    public void CrimeFeeds() {
        ...
        String url = "https://www.homiezin.com/api/feed/Opportunity/";
...
//					emptyElement.setVisibility(View.VISIBLE);
                            ...
                            adapter = new CrimeCustomAdpater((ArrayList<GetFeedx>) FeedCrimeList,OpportunitiesActivity.this);
                            recyclerView.setAdapter(adapter);
                        }
                    }
                });
