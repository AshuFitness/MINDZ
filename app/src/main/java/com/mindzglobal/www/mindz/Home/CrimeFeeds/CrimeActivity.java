...
public class CrimeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        token = manager.getPreferences(CrimeActivity.this, Constants.USER_TOKEN);

        recyclerView = findViewById(R.id.recycler_crime);
        recyclerView.setHasFixedSize(true);
        myOnClickListener = new MyOnClickListener(CrimeActivity.this);
        layoutManager = new LinearLayoutManager(CrimeActivity.this);
