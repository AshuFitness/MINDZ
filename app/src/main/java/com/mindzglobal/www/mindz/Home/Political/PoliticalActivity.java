package com.mindzglobal.www.mindz.Home.Political;
...
public class PoliticalActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        token = manager.getPreferences(PoliticalActivity.this, Constants.USER_TOKEN);

        recyclerView = findViewById(R.id.recycler_crime);
        recyclerView.setHasFixedSize(true);
        myOnClickListener = new PoliticalActivity.MyOnClickListener(PoliticalActivity.this);
        layoutManager = new LinearLayoutManager(PoliticalActivity.this);
    ...
    public void CrimeFeeds() {
        ...
        String url = "https://www.homiezin.com/api/feed/Political/";
...
//					emptyElement.setVisibility(View.VISIBLE);
                            ...
                            adapter = new CrimeCustomAdpater((ArrayList<GetFeedx>) FeedCrimeList,PoliticalActivity.this);
                            recyclerView.setAdapter(adapter);
                        }
                    }
                });
