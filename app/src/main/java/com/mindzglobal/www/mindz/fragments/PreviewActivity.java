...
import com.mindzglobal.www.mindz.TestActivity;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.confirm_media_result) {
            Intent in=new Intent(PreviewActivity.this,TestActivity.class);
//            in.putExtra("camera","gallery");
            in.putExtra(RESPONSE_CODE_ARG, ACTION_CONFIRM).putExtra(FILE_PATH_ARG, previewFilePath);
