...
//            gotoTrim(duration[0]);
  ...
  /*  private void gotoTrim(String path) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        printNamesToLogCat(VideoGallery.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_VIDEO_TRIMMER) {
                ...
                if (selectedUri != null) {
//                    gotoTrim(AbsoluteFilePath.getPath(VideoGallery.this,selectedUri));
                } else {
                    Toast.makeText(VideoGallery.this, "Video not retrieve try again", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
