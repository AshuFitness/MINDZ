package com.mindzglobal.www.mindz.Home.AreaProblem;
...
public class AreaProblemActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.area_problem_layout);

        retrofitClient = new RetrofitClient(token);
        manager = new SessionManager();
        token = manager.getPreferences(AreaProblemActivity.this, Constants.USER_TOKEN);

        recyclerView = findViewById(R.id.recycler_crime);
        recyclerView.setHasFixedSize(true);
        myOnClickListener = new AreaProblemActivity.MyOnClickListener(AreaProblemActivity.this);
        layoutManager = new LinearLayoutManager(AreaProblemActivity.this);
    ...
    public void CrimeFeeds() {
        ...
        String url = "https://www.homiezin.com/api/feed/AreaProblem/";
...
//					emptyElement.setVisibility(View.VISIBLE);
                            ...
                            adapter = new CrimeCustomAdpater((ArrayList<GetFeedx>) FeedCrimeList,AreaProblemActivity.this);
                            recyclerView.setAdapter(adapter);
                        }
                    }
                });
