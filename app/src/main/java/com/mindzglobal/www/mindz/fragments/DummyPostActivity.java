...
public class DummyPostActivity extends AppCompatActivity implements GalleryClickedPosition, ChatScreenCallback, CameraInterface,GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        token = manager.getPreferences(DummyPostActivity.this, Constants.USER_TOKEN);
        user_pic = manager.getPreferences(DummyPostActivity.this, Constants.USER_PROFILE_PIC);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(DummyPostActivity.this).load(Config.BASE_URL_MEDIA+user_pic)
                                .centerCrop()
        ...
        permissionUtils=new PermissionUtils(DummyPostActivity.this);
...
//                bottom.setVisibility(View.VISIBLE);
        ...
        SharedPreferenceSingleton.getInstance().init(DummyPostActivity.this);
        ...
        if (filePath != null && actual_path != null) {
            ...
            MediaController myMediaController = new MediaController(DummyPostActivity.this);
        ...
        mPostBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imageList.getVisibility() == View.VISIBLE) {
                    ...
                    Intent intent = new Intent(DummyPostActivity.this, HomeFragment.class);
                    intent.putExtra("fragmentload", "");
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                    startActivity(intent);
                } else {
                    DummyPostActivity.this.finish();
                }
            }
        });
    ...
    private void uploadMultiFile() {
        ...
        RetrofitClient.getClient().uploadMultiFile(requestBody,"application/json","Bearer "+token).enqueue(new GlobalCallback<String>(mAddImage) {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                Toast.makeText(DummyPostActivity.this, ""+response.body().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                currentLocation=address;
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(DummyPostActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    @Override
    public void clicked(List<String> imagePath, int requestNumber) {
        ...
        if (requestNumber == 0) {
            ...
            Intent it = new Intent(DummyPostActivity.this, BrowsePicture2.class);
    ...
    private void madapter_item_click() {
        mAdapter.setOnItemClickListener(new SelectedGalaryImageAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, List<String> imagePath, int clickedPosition) {
                //selectedPath = imagePath;
                Intent intent = new Intent(DummyPostActivity.this, ActivityGallery_Viewpager.class);
                intent.putStringArrayListExtra(ApplicationConstants.FILTERED_IMAGE_PATH, (ArrayList<String>) imagePath);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                SharedPreferenceSingleton.getInstance().writeStringPreference(ApplicationConstants.CAPTURED_IMAGE_PATH,fileUri.getPath());
